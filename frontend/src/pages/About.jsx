          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 lg:col-span-10">
              ...
              <p className="font-body text-lg md:text-xl text-ivory/70 mt-10 max-w-3xl leading-relaxed">
                P Suman &amp; Associates is a technology-enabled Chartered Accountancy and advisory firm headquartered in Kolkata with PAN-India practice reach. Over 15+ years, PSA has built India&apos;s most rigorous inventory intelligence practice and a full-spectrum audit and advisory capability — serving 200+ clients across 12 sectors PAN India.
              </p>
            </div>
          </div>
        </div>
