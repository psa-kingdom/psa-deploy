"""
Initial seed articles for PSA Insights CMS.
Mirrors the initial editorial articles from frontend/src/data/articles.js.
"""
...
INITIAL_INSIGHTS = [
  {
    ...
    "image": "https://images.unsplash.com/photo-1762427354051-a9bdb181ae3b?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "March 2026",
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1523875194681-bedd468c58bf?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "February 2026",
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1616432043562-3671ea2e5242?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "February 2026",
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1627309366653-2dedc084cdf1?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "January 2026",
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1775163024488-e88e4a71179f?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "January 2026",
    "read_time": "9 min read",
    "author": "CA Prem Suman",
    "toc": [
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1553413077-190dd305871c?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "December 2025",
    "read_time": "10 min read",
    "author": "CA Prem Suman",
    "toc": [
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1642522029686-5485ea7e6042?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "December 2025",
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1713461983836-de0a45009424?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "November 2025",
    "read_time": "9 min read",
    "author": "CA Prem Suman",
    "toc": [
...
"""
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1639772823849-6efbd173043c?crop=entropy&cs=srgb&fm=jpg&w=1600&q=80",
    "date": "November 2025",
    "read_time": "8 min read",
    "author": "CA Prem Suman",
    "toc": [
